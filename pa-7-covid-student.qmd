...
author: "Cherie Wang & Megan Redican"
format: 
  html: default
  gfm: default
...
#calculating total number of cases per state
state_totals <- cases |> 
  group_by(state) |> 
  ...
  ggplot(aes(x = total, 
    ...
    geom_col() + 
      labs(x = "Number of Cases",
       y = "Top 10 States",
       title = "Top 10 Covid Cases in the US") + 
  theme_bw() 
...
>With the data we had yes! But we could also compare amount of covid cases by population rather than state.
